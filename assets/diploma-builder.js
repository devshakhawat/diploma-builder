jQuery(document).ready(function($) {
    ...
    function updateReviewSummary() {
        $('#review-student-name').text(currentConfig.student_name || 'Your Name');
        $('#review-school-name').text(currentConfig.school_name || 'Your High School Name');
    ...
    function generateDiplomaHTML() {
        ...
        let $signature = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="290" height="111" viewBox="0 0 290 111" fill="none">
        ...
        let $signature2 = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="290" height="119" viewBox="0 0 290 119" fill="none">
        ...
        let $signature3 = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="291" height="119" viewBox="0 0 291 119" fill="none">
        ...
        <div class="diploma">            
            ...
            <div class="location-seal-section">
                <div class="location-left">${$signature3}</div>               
                    ${emblemInfo.html}                
