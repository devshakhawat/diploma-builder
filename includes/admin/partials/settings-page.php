<div class="wrap diploma-builder-settings">
    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
            ...
            <tr>
                <th scope="row"><?php _e('Product ID', 'diploma-builder'); ?></th>
                <td>
                    <fieldset>
                        <legend class="screen-reader-text"><span><?php _e('Product ID', 'diploma-builder'); ?></span></legend>
                        <input name="diploma_product_id" type="text" id="diploma_product_id" value="<?php echo esc_attr(get_option('diploma_product_id', '')); ?>" class="small-text">
                        <p class="description"><?php _e('Enter the Product ID for the diploma', 'diploma-builder'); ?></p>
                    </fieldset>
                </td>
            </tr>
        </table>
