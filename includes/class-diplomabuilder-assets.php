    ...
    public function enqueue_frontend_assets() {
        ...
        if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'diploma_builder')) {
            ...
            wp_enqueue_style(
                ...
                'https://fonts.googleapis.com/css2?family=Cinzel:wght@400;500;600;700&family=Dancing+Script:wght@400;700&family=Playfair+Display:ital,wght@0,400;0,700;0,800;1,400;1,700&display=swap',
                array(),
                null
            );
